...
%% Define broadband FF monitor
monitor.Reset();
monitor.Name('farfield (broadband)');
monitor.Domain('Time');
monitor.Accuracy('1e-3');
monitor.Samples('nsamplesperGHz * (fmax-fmin) + 1');
monitor.FieldType('Farfield');
monitor.TransientFarfield('False');
